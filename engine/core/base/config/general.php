...
return [
    ...
    'memory_limit' => env('CMS_MEMORY_LIMIT', '1024M'),
    'date_format' => [
    ...
    // ────────────────────────────────────────────────────────────────────
    // Morph Map — Polymorphic Relation Registry
    //
    // กำหนด alias → FQCN เพื่อป้องกัน class name รั่วในฐานข้อมูล
    // และรองรับ Laravel enforceMorphMap() ใน CoreServiceProvider
    //
    // วิธีเพิ่ม: เพิ่ม entry ใหม่ที่นี่เท่านั้น ไม่ต้องแก้ Provider
    // Module อื่นที่ต้องการ register morph type ของตัวเองให้ใช้
    // $this->mergeConfigFrom() ใน ServiceProvider ของ module นั้น
    // ────────────────────────────────────────────────────────────────────
    'morph_map' => [
        // People types
        'anonymous_people' => App\Models\AnonymousPeople::class,
        'th_people' => App\Models\ThPeople::class,
        'foreigners_people' => App\Models\ForeignersPeople::class,
        'tourist_foreigners_people' => App\Models\TouristForeignersPeople::class,
        // Media types
