...
/**
 * MimeTypeResolver — จัดการ MIME type และนามสกุลไฟล์
 *
 * ความรับผิดชอบ:
 * - ดึง MIME type จากนามสกุลไฟล์
 * - ดึงนามสกุลไฟล์จาก MIME type
 * - ตรวจสอบ validity ของนามสกุลและ MIME type
 */
final class MimeTypeResolver
{
     ...
     * @return string|null MIME type หรือ null ถ้าไม่รู้จัก
     */
     ...
     * @param  string|null  $proposedExtension  นามสกุลที่แนะนำ (ตรวจสอบก่อน)
     * @return string|null นามสกุลไฟล์ หรือ null ถ้าไม่รู้จัก
     */
    ...
    /**
     * ดึง MIME types ทั้งหมดของนามสกุลไฟล์
     *
     * @param  string  $extension  นามสกุลไฟล์
     * @return array<string> รายการ MIME types
     */
    public static function getAllTypesForExtension(string $extension): array
    {
        $extension = trim(strtolower($extension), '. ');
    ...
    /**
     * ตรวจสอบว่านามสกุลไฟล์รู้จักหรือไม่
     *
     * @param  string  $extension  นามสกุลไฟล์
     */
    ...
    /**
     * ตรวจสอบว่า MIME type รู้จักหรือไม่
     *
     * @param  string  $type  MIME type
     */
