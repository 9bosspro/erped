...
interface RsaHelperInterface
{
    ...
    /**
     * สกัดกุญแจ AES และเข้ารหัสด้วย RSA
     *
     * @return array{aesKey: string, encryptedKey: string}
     */
    public function encryptKeys(?string $publicKeyPem): array;

    /**
     * เข้ารหัส AES-256-GCM พร้อม AAD
     *
     * @return array{iv: string, tag: string, ciphertext: string, aad: string}
     */
