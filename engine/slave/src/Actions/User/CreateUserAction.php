...
/**
 * CreateUserAction — Action สำหรับสร้างบัญชีผู้ใช้ใหม่
 *
 * เปลี่ยนชื่อจาก RecordUserLoginAction เพื่อให้สื่อความหมายที่ถูกต้อง (LSP)
 * ชื่อเดิมสื่อว่า "บันทึก login" แต่จริงๆ คือ "สร้าง user"
 */
